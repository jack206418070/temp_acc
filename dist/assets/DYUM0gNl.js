import{d as N,r as o,g as P,J as x,u as L,c as t,a as g,p as v,F as w,b as f,o as r,n as _,t as j,_ as I}from"./DQTXiCtR.js";const K={key:0,class:"service-banner"},M={class:"category-tabs"},C={class:"tabs-scroll"},S=["onClick"],J={key:0,class:"qa-list"},U=["onClick"],H=["innerHTML"],E={key:1,class:"service-banner"},$=N({__name:"qa",setup(B){const l=o(null),c=o(""),u=o([]),s=o([]),A=[{id:"1",meta_data:{name:"民眾申請篇"},qa_content:{計畫說明:`<p>1.&nbsp;什麼是多元陪伴照顧服務？</p>
    ...
    <p>A：一般在安全的情況下沒有距離上的限制，但若遇特殊情況時（例如評估有安全之虞或無適當交通工具等），提供服務的試辦單位可與申請民眾討論協議相對應之服務條件並載明於服務契約中。</p>`,服務諮詢:`<p>47.&nbsp;想瞭解多元陪伴照顧服務更細部資訊，是否有諮詢服務專線？</p>
...
`}},{id:"3",meta_data:{name:"外國籍陪伴照顧服務工作者篇"},qa_content:{聘僱規定:`<p>1.&nbsp;如要應聘為陪伴照顧服務工作者，需具備何種資格?</p>
    ...
    <ul>
        ...
        <li>外國人人數達五十人以上未滿一百人者，至少設置二人。</li>
        <li>外國人人數達一百人以上者，至少設置三人；每增加一百人者，至少增置一人。</li>
    </ul>`}}],m=x(),d=i=>{var e;c.value=i,s.value=[],q(((e=l.value)==null?void 0:e.qa_content[i])||"")},T=i=>{const e=s.value.indexOf(i);e>-1?s.value.splice(e,1):s.value.push(i)},q=i=>{var k;const e=document.createElement("div");e.innerHTML=i;const n=Array.from(e.children),a=[];let p="",h="";for(const b of n){const y=((k=b.textContent)==null?void 0:k.trim())||"";/^\d+[.．、]?\s*/.test(y)?(p&&a.push({question:p,answer:h}),p=y,h=""):h+=b.outerHTML}p&&a.push({question:p,answer:h}),u.value=a};return P(()=>{const i=m.query.id,e=m.query.lang||"";if(i){const n=A.find(a=>a.id===i);if(n){L({title:`QA ${n.meta_data.name}｜多元陪伴照顧服務計畫`});let a={};if(i==="3"){switch(e){case"en":a=n.qa_content_en||{};break;case"vi":a=n.qa_content_vi||{};break;case"id":a=n.qa_content_id||{};break;case"th":a=n.qa_content_th||{};break;default:a=n.qa_content||{}}l.value={id:"3",meta_data:n.meta_data,qa_content:a}}else a=n.qa_content||{},l.value=n;const p=Object.keys(a)[0];p&&d(p)}}}),(i,e)=>(r(),t("div",null,[l.value?(r(),t("div",K,[g("div",M,[g("div",C,[(r(!0),t(w,null,f(l.value.qa_content,(n,a)=>(r(),t("button",{key:a,onClick:p=>d(a),class:_({active:a===c.value})},j(a),11,S))),128))])]),c.value?(r(),t("div",J,[(r(!0),t(w,null,f(u.value,(n,a)=>(r(),t("div",{class:"qa-item",key:a},[g("div",{class:"qa-title",onClick:p=>T(a)},j(n.question),9,U),s.value.includes(a)?(r(),t("div",{key:0,class:"qa-content",innerHTML:n.answer},null,8,H)):v("",!0)]))),128))])):v("",!0)])):(r(),t("div",E,e[0]||(e[0]=[g("p",null,"資料載入中...",-1)])))]))}}),V=I($,[["__scopeId","data-v-3c6fcf75"]]);export{V as default};
