import{d as N,r as g,o as P,u as _,a as x,c as t,b as c,e as w,F as f,f as j,g as r,n as L,t as A,_ as I}from"./BkPg41o2.js";const C={key:0,class:"service-banner"},K={class:"category-tabs"},M={class:"tabs-scroll"},S=["onClick"],J={key:0,class:"qa-list"},U=["onClick"],H=["innerHTML"],B={key:1,class:"service-banner"},E=N({__name:"qa_test",setup($){const l=g(null),u=g(""),m=g([]),s=g([]),d=[{id:"1",meta_data:{name:"民眾申請篇"},qa_content:{計畫說明:`<p>1.&nbsp;什麼是多元陪伴照顧服務？</p>
...
`}},{id:"3",meta_data:{name:"外國籍陪伴照顧服務工作者篇"},qa_content:{聘僱規定:`<p>1.&nbsp;如要應聘為陪伴照顧服務工作者，需具備何種資格?</p>
    ...
    <ul>
        ...
        <li>外國人人數達五十人以上未滿一百人者，至少設置二人。</li>
        <li>外國人人數達一百人以上者，至少設置三人；每增加一百人者，至少增置一人。</li>
    </ul>`}}],k=_(),b=i=>{var e;u.value=i,s.value=[],q(((e=l.value)==null?void 0:e.qa_content[i])||"")},T=i=>{const e=s.value.indexOf(i);e>-1?s.value.splice(e,1):s.value.push(i)},q=i=>{var e;{const n=document.createElement("div");n.innerHTML=i;const a=Array.from(n.children),p=[];let h="",o="";for(const y of a){const v=((e=y.textContent)==null?void 0:e.trim())||"";/^\d+[.．、]?\s*/.test(v)?(h&&p.push({question:h,answer:o}),h=v,o=""):o+=y.outerHTML}h&&p.push({question:h,answer:o}),m.value=p}};return P(()=>{const i=k.query.id,e=k.query.lang||"";if(console.log(i),console.log(e),console.log(d),i){const n=d.find(a=>a.id===i);if(n){console.log(n),x({title:`QA ${n.meta_data.name}｜多元陪伴照顧服務計畫`});let a={};if(i==="3"){switch(console.log("in"),e){case"en":a=n.qa_content_en||{};break;case"vi":a=n.qa_content_vi||{};break;case"id":a=n.qa_content_id||{};break;case"th":a=n.qa_content_th||{};break;default:a=n.qa_content||{}}l.value={id:"3",meta_data:n.meta_data,qa_content:a},console.log(l.value)}else a=n.qa_content||{},l.value=n;console.log(a);const p=Object.keys(a)[0];console.log(p),p&&b(p)}}}),(i,e)=>(r(),t("div",null,[l.value?(r(),t("div",C,[c("div",K,[c("div",M,[(r(!0),t(f,null,j(l.value.qa_content,(n,a)=>(r(),t("button",{key:a,onClick:p=>b(a),class:L({active:a===u.value})},A(a),11,S))),128))])]),u.value?(r(),t("div",J,[(r(!0),t(f,null,j(m.value,(n,a)=>(r(),t("div",{class:"qa-item",key:a},[c("div",{class:"qa-title",onClick:p=>T(a)},A(n.question),9,U),s.value.includes(a)?(r(),t("div",{key:0,class:"qa-content",innerHTML:n.answer},null,8,H)):w("",!0)]))),128))])):w("",!0)])):(r(),t("div",B,e[0]||(e[0]=[c("p",null,"資料載入中...",-1)])))]))}}),V=I(E,[["__scopeId","data-v-44a2b12b"]]);export{V as default};
