...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><iframe width="560" height="315" src="https://www.youtube.com/embed/OxRL7eKReVQ?si=hhulgueBNpIueGKd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen data-v-741293fc></iframe><div class="main-container home-content" data-v-741293fc><div class="home-top" data-v-741293fc><h2 data-v-741293fc>\u6700\u65B0\u6D88\u606F</h2></div>`);
      if (loading.value) {
        _push(`<div class="loading-container" data-v-741293fc><div class="loading-spinner" data-v-741293fc></div><p data-v-741293fc>\u8F09\u5165\u4E2D...</p></div>`);
      } else if (error.value) {
        _push(`<div class="error-container" data-v-741293fc><p data-v-741293fc>${ssrInterpolate(error.value)}</p></div>`);
      } else {
        _push(`<div class="home-new" data-v-741293fc><!--[-->`);
        ssrRenderList(announcements.value, (announcement) => {
          _push(`<div class="new-item" data-v-741293fc><div class="new-title" data-v-741293fc><div class="title-text" data-v-741293fc>${ssrInterpolate(announcement.category)}</div><div class="title-date" data-v-741293fc>${ssrInterpolate(formatDate(announcement.publish_date))}</div></div><div class="new-link" data-v-741293fc>`);
          if (announcement.content.length > 10) {
            _push(`<a${ssrRenderAttr("href", "/news/" + announcement.id)} data-v-741293fc>${ssrInterpolate(announcement.title)}</a>`);
          } else {
            _push(`<a${ssrRenderAttr("href", announcement.link)} target="_blank" data-v-741293fc>${ssrInterpolate(announcement.title)}</a>`);
          }
          _push(`</div><div class="item-line" data-v-741293fc></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-741293fc"]]);

export { index as default };
//# sourceMappingURL=index-jawkmBUZ.mjs.map
