...
const news_data:IBlog[] = [
  ...
  },
  {
    ...
    date:'2024年1月8日',
    title:'【服務心得分享】照顧服務員：看見服務的價值與意義',
    author:'試辦單位',
    content:'在多元照顧服務計畫實施後，來自各試辦單位的照顧服務員分享了他們的服務經驗。透過靈活的時段安排和個人化的照顧方式，不僅能更好地滿足案家需求，也讓照顧服務更有效率。一位資深照顧服務員表示：「這種新型態的服務模式讓我們能更貼近案家需求，同時也讓我們的專業能力得到更好的發揮。」',
    post_info:'試辦單位 . 3分鐘閱讀 . 最新消息',
    category:'community-health',
    page:'news-list',
    catalog:'使用心得分享'
