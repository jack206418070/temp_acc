...
const _routes = [
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_id_-Daoj6Ule.js")
  },
  {
  ...
  },
  {
    name: "blog-details",
    path: "/blog-details",
    component: () => import("./_nuxt/index-nJW00I-W.js")
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_id_-BDepjyO0.js")
  },
  {
...
const security_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
  ...
  const isStaticResource = path.startsWith("/images/") || path.startsWith("/assets/") || path.startsWith("/public/") || path.startsWith("/uploads/") || /\.(png|jpg|jpeg|gif|svg|ico|css|js|woff|woff2|ttf|eot|avif|webp)$/i.test(path);
  let isSuspicious;
  if (isStaticResource) {
