...
import { sanitizeStatusCode, createError as createError$1, setResponseStatus as setResponseStatus$1, appendHeader, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie } from "C:/Users/c3d19/accompany-web-site/node_modules/h3/dist/index.mjs";
...
import { withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/c3d19/accompany-web-site/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import("./_nuxt/notfound-BicXDnYN.js")
  },
  {
    name: "qa_test2",
    path: "/qa_test2",
    component: () => import("./_nuxt/qa_test2-0aRiZq7v.js")
  },
  {
    name: "services",
    path: "/services",
  ...
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-BTSI47Id.js")
  },
  {
    name: "news-id",
    path: "/news/:id()",
    component: () => import("./_nuxt/_id_-Bklu7U7b.js")
  },
  {
    name: "news",
    path: "/news",
  ...
  },
  {
    name: "propaganda",
    path: "/propaganda",
    component: () => import("./_nuxt/propaganda-BjjLxKLn.js")
  },
  {
    name: "service-v1",
    path: "/service-v1",
  ...
  },
  {
    name: "service-now",
    path: "/service-now",
    component: () => import("./_nuxt/service-now-U59AEHwI.js")
  },
  {
    name: "announcement",
    path: "/announcement",
  ...
  },
  {
    name: "conduct-plan",
    path: "/conduct-plan",
    component: () => import("./_nuxt/conduct-plan-QYW_0Ddz.js")
  },
  {
    name: "join-us-unit",
    path: "/join-us-unit",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/banners-CMRRsRq7.js")
  },
  {
    name: "reserve-guide",
    path: "/reserve-guide",
  ...
  },
  {
    name: "service-price",
    path: "/service-price",
    component: () => import("./_nuxt/service-price-C5DqJ_xu.js")
  },
  {
    name: "admin-dashboard",
    path: "/admin/dashboard",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/dashboard-37jQK513.js")
  },
  {
    name: "admin-knowledge",
    path: "/admin/knowledge",
    meta: __nuxt_page_meta$4 || {},
    component: () => import("./_nuxt/knowledge-Bb2GXOWF.js")
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/knowledge2-D2PpAG5U.js")
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_id_-Bg44sxHf.js")
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/service-unit-MXQcfyDZ.js")
  },
  {
    name: "blog-details",
    path: "/blog-details",
    component: () => import("./_nuxt/index-DPgu8pNi.js")
  },
  {
    name: "service-apply-form",
    path: "/service-apply-form",
    component: () => import("./_nuxt/service-apply-form-Dt5XCeZi.js")
  },
  {
    name: "admin-announcements",
    path: "/admin/announcements",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/announcements-Cy4W4vRl.js")
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_id_-CSwLqcCq.js")
  },
  {
...
const input_45validation_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
  return;
});
const security_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
  ...
  const isStaticResource = path.startsWith("/images/") || path.startsWith("/assets/") || path.startsWith("/public/") || path.startsWith("/uploads/") || path.startsWith("/_nuxt/") || /\.(png|jpg|jpeg|gif|svg|ico|css|js|woff|woff2|ttf|eot|avif|webp)$/i.test(path);
  let isSuspicious;
  if (isStaticResource) {
    const staticSuspiciousPatterns = [
      ...
      // 過長的路徑（可能是緩衝區溢出攻擊）
      /.{1000,}/,
      // 正常的空格編碼(%20)除外，但檢測異常URL編碼
      /%(?!20)[0-9a-fA-F]{2}/
    ];
    isSuspicious = staticSuspiciousPatterns.some(
      (pattern) => pattern.test(path) || pattern.test(query)
    );
  } else {
    isSuspicious = suspiciousPatterns.some(
      (pattern) => pattern.test(path) || pattern.test(query)
    );
  }
  if (isSuspicious) {
...
const layouts = {
  ...
  default: defineAsyncComponent(() => import("./_nuxt/default-OiIy_aX6.js").then((m) => m.default || m)),
  "layout-one": defineAsyncComponent(() => import("./_nuxt/layout-one-a5v0ijJO.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<button class="btn btn-outline-secondary btn-lg"><i class="bi bi-arrow-left me-2"></i>返回上頁 </button></div></div><img${ssrRenderAttr("src", _imports_0)} alt="" class="lazy-img shapes shape_01" style="${ssrRenderStyle({ "opacity": "0.1" })}"><img${ssrRenderAttr("src", _imports_1)} alt="" class="lazy-img shapes shape_02" style="${ssrRenderStyle({ "opacity": "0.1" })}"></div></main></div>`);
    };
  }
});
