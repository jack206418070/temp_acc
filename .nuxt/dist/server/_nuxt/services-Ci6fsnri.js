...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-container" }, _attrs))} data-v-b93215d9><div class="" data-v-b93215d9><div class="details-meta ps-xxl-5 ps-xl-3" data-v-b93215d9><div class="reminder-block" data-v-b93215d9>${decode(reminder_data.value) ?? ""}</div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=services-Ci6fsnri.js.map
