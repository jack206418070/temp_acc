  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="post-category" data-v-35b8383f>類別：${ssrInterpolate(blog.value.category)}</div></div><div class="post-details-meta" data-v-35b8383f> 內容：<br data-v-35b8383f><div class="post-content" data-v-35b8383f>${decode(blog.value.content) ?? ""}</div></div>`);
        if (blog.value.link) {
      ...
      if (showPopup.value && imageList.value.length) {
        ...
        _push(`<button class="close-btn" data-v-35b8383f>×</button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--]-->`);
...
//# sourceMappingURL=news-details-area-z3caIVMt.js.map
