import{d as N,r as g,o as P,u as x,a as L,c as p,b as c,e as v,F as w,f,g as t,n as _,t as j,_ as I}from"./BCy4Zdlc.js";const C={key:0,class:"service-banner"},K={class:"category-tabs"},M={class:"tabs-scroll"},S=["onClick"],J={key:0,class:"qa-list"},U=["onClick"],H=["innerHTML"],B={key:1,class:"service-banner"},E=N({__name:"qa",setup($){const l=g(null),u=g(""),m=g([]),s=g([]),A=[{id:"1",meta_data:{name:"民眾申請篇"},qa_content:{計畫說明:`<p>1.&nbsp;什麼是多元陪伴照顧服務？</p>
...
`}},{id:"3",meta_data:{name:"外國籍陪伴照顧服務工作者篇"},qa_content:{聘僱規定:`<p>1.&nbsp;如要應聘為陪伴照顧服務工作者，需具備何種資格?</p>
    ...
    <ul>
        ...
        <li>外國人人數達五十人以上未滿一百人者，至少設置二人。</li>
        <li>外國人人數達一百人以上者，至少設置三人；每增加一百人者，至少增置一人。</li>
    </ul>`}}],d=x(),k=i=>{var e;u.value=i,s.value=[],q(((e=l.value)==null?void 0:e.qa_content[i])||"")},T=i=>{const e=s.value.indexOf(i);e>-1?s.value.splice(e,1):s.value.push(i)},q=i=>{var e;{const n=document.createElement("div");n.innerHTML=i;const a=Array.from(n.children),r=[];let h="",o="";for(const b of a){const y=((e=b.textContent)==null?void 0:e.trim())||"";/^\d+[.．、]?\s*/.test(y)?(h&&r.push({question:h,answer:o}),h=y,o=""):o+=b.outerHTML}h&&r.push({question:h,answer:o}),m.value=r}};return P(()=>{const i=d.query.id,e=d.query.lang||"";if(i){const n=A.find(a=>a.id===i);if(n){L({title:`QA ${n.meta_data.name}｜多元陪伴照顧服務計畫`});let a={};if(i==="3"){switch(e){case"en":a=n.qa_content_en||{};break;case"vi":a=n.qa_content_vi||{};break;case"id":a=n.qa_content_id||{};break;case"th":a=n.qa_content_th||{};break;default:a=n.qa_content||{}}l.value={id:"3",meta_data:n.meta_data,qa_content:a}}else a=n.qa_content||{},l.value=n;const r=Object.keys(a)[0];r&&k(r)}}}),(i,e)=>(t(),p("div",null,[l.value?(t(),p("div",C,[c("div",K,[c("div",M,[(t(!0),p(w,null,f(l.value.qa_content,(n,a)=>(t(),p("button",{key:a,onClick:r=>k(a),class:_({active:a===u.value})},j(a),11,S))),128))])]),u.value?(t(),p("div",J,[(t(!0),p(w,null,f(m.value,(n,a)=>(t(),p("div",{class:"qa-item",key:a},[c("div",{class:"qa-title",onClick:r=>T(a)},j(n.question),9,U),s.value.includes(a)?(t(),p("div",{key:0,class:"qa-content",innerHTML:n.answer},null,8,H)):v("",!0)]))),128))])):v("",!0)])):(t(),p("div",B,e[0]||(e[0]=[c("p",null,"資料載入中...",-1)])))]))}}),V=I(E,[["__scopeId","data-v-7c91dec6"]]);export{V as default};
