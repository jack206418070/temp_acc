import{d as N,r as g,o as P,u as x,a as L,c as p,b as c,e as v,F as w,f,g as t,n as _,t as j,_ as I}from"./CWqdnwWO.js";const C={key:0,class:"service-banner"},K={class:"category-tabs"},M={class:"tabs-scroll"},S=["onClick"],J={key:0,class:"qa-list"},U=["onClick"],H=["innerHTML"],B={key:1,class:"service-banner"},E=N({__name:"qa",setup($){const l=g(null),u=g(""),m=g([]),s=g([]),A=[{id:"1",meta_data:{name:"民眾申請篇"},qa_content:{計畫說明:`<p>1.&nbsp;什麼是多元陪伴照顧服務？</p>
