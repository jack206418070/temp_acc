...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    ...
    '/api/captcha': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/captcha').default>>>>
    }
    '/api/createdb': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/createdb/index.get').default>>>>
    }
    '/api/error-handler': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/error-handler').default>>>>
    }
    '/api/health-check': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/health-check.get').default>>>>
    }
    '/api/knowledge/:id': {
    ...
    '/api/security-config': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/security-config').default>>>>
    }
    '/api/service-unit/:id': {
