...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getHeader, removeResponseHeader, createApp, handleCors, getRequestIP, getQuery as getQuery$1, readMultipartFormData, readBody, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, setCookie, deleteCookie, setHeader, getResponseStatusText } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/h3/dist/index.mjs';
...
import unstorage_47drivers_47lru_45cache from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/unstorage/drivers/lru-cache.mjs';
...
import defu, { defuFn, createDefu } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/defu/dist/defu.mjs';
...
import { FilterXSS } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/xss/lib/index.js';
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ginjack/Desktop/temp_acc","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ginjack/Desktop/temp_acc/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ginjack/Desktop/temp_acc/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ginjack/Desktop/temp_acc/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/ginjack/Desktop/temp_acc/.data/kv"}));
...
const _69lSATa_V459qAzhAryfGK9fVI517PwSbjRxXGOpxys = defineNitroPlugin(async (nitroApp) => {
...
const sriHashes = {"/_nuxt/builds/meta/0600bd2c-f29d-4b22-b050-ae65c9f78b0b.json":"sha384-0qI7x4Pjqjj0AeE8dIhQUTfElUp/2IMx8Vl8X/cREdyAfHNwpbKCxtpUHFbt5p8w","/_nuxt/builds/meta/dev.json":"sha384-6HTfG0fyWx/LG5lif40vqR4j932LPRyU8eUEumu8q+WUUJBJxuR+VsEre0ioL38h","/_nuxt/builds/latest.json":"sha384-HCUPdfw1jU6w7fskqzpEHj2wqkYbFqDA6xKr0XU7vHPLPpOpjqRFkiL6x+xf72sF","/favicon.ico":"sha384-e0DOxab7uI618wwd1Lt0+rREwV1k9myViahHX+GFoxul14+FbxXyAOIdbDRGgPYP"};
...
const _Q1IFod6Hjau3nsLlm40w6xByR_V6mfEmI7ruAI6mTb8 = defineNitroPlugin((nitroApp) => {
...
const _QvJggHQYMTQU_K4ldfDE0XZTzw8WiK5GIqYNS_vDw = defineNitroPlugin((nitroApp) => {
  {
    return;
  }
});
...
const _cDusxOWJiPB0AUiNXS9bXtymP248DNzamrKRWrxHlQ = defineNitroPlugin((nitroApp) => {
...
const _l1H4e0MvXW3XTVhMa0Mng8wDrb1fwuraygeZXNr3F1s = defineNitroPlugin((nitroApp) => {
...
const _B8tIqyqGP27hcLNMFnyRJcsgGfXMfeO5JKpREnnwqcM = defineNitroPlugin((nitroApp) => {
  {
    return;
  }
});

const _NV5LKrz_1IzUBNcosyC1aAiHqT7X4FJzO1I0UnJ48eM = defineNitroPlugin((nitroApp) => {
...
const _rQf0a8luPytQAJnEnxNk74kQ_rNbmj74rRkiWFTBZDQ = defineNitroPlugin((nitroApp) => {
...
const _myNg36CyTou_OhGn88vafeAxs1xh22M_bXXlfaRJhjI = defineNitroPlugin(async (nitroApp) => {
  {
...
_69lSATa_V459qAzhAryfGK9fVI517PwSbjRxXGOpxys,
_Q1IFod6Hjau3nsLlm40w6xByR_V6mfEmI7ruAI6mTb8,
_QvJggHQYMTQU_K4ldfDE0XZTzw8WiK5GIqYNS_vDw,
_cDusxOWJiPB0AUiNXS9bXtymP248DNzamrKRWrxHlQ,
_l1H4e0MvXW3XTVhMa0Mng8wDrb1fwuraygeZXNr3F1s,
_B8tIqyqGP27hcLNMFnyRJcsgGfXMfeO5JKpREnnwqcM,
_NV5LKrz_1IzUBNcosyC1aAiHqT7X4FJzO1I0UnJ48eM,
_rQf0a8luPytQAJnEnxNk74kQ_rNbmj74rRkiWFTBZDQ,
_myNg36CyTou_OhGn88vafeAxs1xh22M_bXXlfaRJhjI
];
...
const _amdomy = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _B3BSI_ = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _aq_W2E = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _DN9A69 = defineEventHandler(async (event) => {
  const rules = resolveSecurityRules(event);
...
const _ojDTbN = defineEventHandler(async (event) => {
  const rules = resolveSecurityRules(event);
...
const handlers = [
  ...
  { route: '', handler: _amdomy, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _B3BSI_, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _aq_W2E, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _DN9A69, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _ojDTbN, lazy: false, middleware: false, method: undefined },
