import { defineComponent, ref, computed, mergeProps, unref, useSSRContext } from 'file://C:/Users/mcsadmin/Desktop/accompany-web-site/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderStyle } from 'file://C:/Users/mcsadmin/Desktop/accompany-web-site/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        ...
        ssrRenderList(unref(filteredVendors), (vendor) => {
          var _a;
          _push(`<div class="vendor-card" data-v-9dffb7a4><img${ssrRenderAttr("src", `/api/service-unit/${vendor.id}/unit-image`)}${ssrRenderAttr("alt", vendor.name)} class="vendor-image" data-v-9dffb7a4><div class="vendor-info" data-v-9dffb7a4><p style="${ssrRenderStyle({ "text-align": "left", "padding": "15px 0", "font-size": "20px" })}" data-v-9dffb7a4>${(_a = vendor.name) != null ? _a : ""}</p><p class="vendor-category" data-v-9dffb7a4><!--[-->`);
...
//# sourceMappingURL=service-unit-list-area-CTGb3nc5.mjs.map
