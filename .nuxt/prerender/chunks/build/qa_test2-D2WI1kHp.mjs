import { defineComponent, ref, watch, unref, useSSRContext } from 'file://C:/Users/c3d19/accompany-web-site/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-52f31c89>`);
      if (!unref(loading)) {
        _push(`<div class="service-banner" data-v-52f31c89><div class="category-tabs" data-v-52f31c89><div class="tabs-scroll" data-v-52f31c89><!--[-->`);
        ssrRenderList(categories.value, (category) => {
          var _a;
          _push(`<button class="${ssrRenderClass({ active: ((_a = activeCategory.value) == null ? void 0 : _a.id) === category.id })}" data-v-52f31c89>${ssrInterpolate(getCategoryName(category))}</button>`);
        });
        _push(`<!--]--></div></div>`);
        if (activeCategory.value) {
          _push(`<div class="qa-list" data-v-52f31c89><!--[-->`);
          ssrRenderList(qaContents.value, (item, index) => {
            var _a;
            _push(`<div class="qa-item" data-v-52f31c89><div class="qa-title" data-v-52f31c89>${ssrInterpolate(item.question)}</div>`);
            if (expandedIndexes.value.includes(index)) {
              _push(`<div class="qa-content" data-v-52f31c89>${(_a = item.answer) != null ? _a : ""}</div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
        ...
        _push(`<div class="service-banner" data-v-52f31c89><p data-v-52f31c89>\u8CC7\u6599\u8F09\u5165\u4E2D...</p></div>`);
      }
      _push(`</div>`);
    };
  }
...
const qa_test2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52f31c89"]]);

export { qa_test2 as default };
//# sourceMappingURL=qa_test2-D2WI1kHp.mjs.map
