...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-container" }, _attrs))} data-v-7247506a><div class="conduct-top" data-v-7247506a><div class="conduct-block" data-v-7247506a>`);
      _push(ssrRenderComponent(_component_Nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg preserveAspectRatio="none" data-bbox="20 50.001 159.999 99.999" viewBox="20 50.001 159.999 99.999" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="shape" role="presentation" aria-hidden="true" aria-label="" data-v-7247506a${_scopeId}><g data-v-7247506a${_scopeId}><path d="M26.097 143.956c8.129 8.058 21.432 8.058 29.561 0L100 100l44.342 43.957c8.129 8.058 21.432 8.058 29.561 0 8.129-8.058 8.129-21.246 0-29.304l-59.122-58.608c-8.129-8.058-21.432-8.058-29.561 0l-59.122 58.608c-8.13 8.058-8.13 21.244-.001 29.303z" data-v-7247506a${_scopeId}></path></g></svg>`);
          } else {
            return [
      ...
      _push(`<h2 class="default-title" data-v-7247506a>\u85CD\u9818\u5BE9\u67E5\u6A19\u6E96</h2></div></div><div class="conduct-content" data-v-7247506a><ul data-v-7247506a><li data-v-7247506a><a href="https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=N0090029" target="_blank" data-v-7247506a>\u85CD\u9818\u5BE9\u67E5\u6A19\u6E96\u9023\u7D50</a></li></ul></div></div>`);
    };
  }
});
...
const censorStandard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7247506a"]]);

export { censorStandard as default };
//# sourceMappingURL=censor-standard-B7tuJSsj.mjs.map
