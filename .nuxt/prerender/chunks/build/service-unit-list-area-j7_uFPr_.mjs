    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        ...
        ssrRenderList(unref(filteredVendors), (vendor) => {
          var _a;
          _push(`<div class="vendor-card" data-v-3fefab01><img${ssrRenderAttr("src", `/api/service-unit/${vendor.id}/unit-image`)}${ssrRenderAttr("alt", vendor.name)} class="vendor-image" data-v-3fefab01><div class="vendor-info" data-v-3fefab01><p style="${ssrRenderStyle({ "text-align": "left", "padding": "15px 0", "font-size": "20px" })}" data-v-3fefab01>${(_a = vendor.name) != null ? _a : ""}</p><p class="vendor-category" data-v-3fefab01><!--[-->`);
...
//# sourceMappingURL=service-unit-list-area-j7_uFPr_.mjs.map
