...
import { $fetch as $fetch$1 } from 'file://C:/inetpub/accompany-web-site/node_modules/ofetch/dist/node.mjs';
import { u as useSeoMeta$1, p as publicAssetsURL, h as headSymbol, b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file://C:/inetpub/accompany-web-site/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/inetpub/accompany-web-site/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file://C:/inetpub/accompany-web-site/node_modules/h3/dist/index.mjs';
import { useRouter as useRouter$1, useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/inetpub/accompany-web-site/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/inetpub/accompany-web-site/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/inetpub/accompany-web-site/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, withQuery, withTrailingSlash, withoutTrailingSlash, isScriptProtocol } from 'file://C:/inetpub/accompany-web-site/node_modules/ufo/dist/index.mjs';
import { parse } from 'file://C:/inetpub/accompany-web-site/node_modules/cookie-es/dist/index.mjs';
import destr from 'file://C:/inetpub/accompany-web-site/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file://C:/inetpub/accompany-web-site/node_modules/ohash/dist/index.mjs';
import { klona } from 'file://C:/inetpub/accompany-web-site/node_modules/klona/dist/index.mjs';
import MasonryWall from 'file://C:/inetpub/accompany-web-site/node_modules/@yeger/vue-masonry-wall/dist/index.mjs';
import Vue3Toastify, { toast } from 'file://C:/inetpub/accompany-web-site/node_modules/vue3-toastify/dist/index.mjs';
import { ssrRenderComponent, ssrRenderAttr, ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'file://C:/inetpub/accompany-web-site/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "qa",
    path: "/qa",
    component: () => import('./qa-CQEAVs21.mjs')
  },
  {
    name: "faq",
    path: "/faq",
    component: () => import('./faq-Dd18zg0E.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BgX5rol7.mjs')
  },
  {
    name: "links",
    path: "/links",
    component: () => import('./links-WTWPW92P.mjs')
  },
  {
    name: "story",
    path: "/story",
    component: () => import('./story-Dv6pkHq5.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-BypiMWQG.mjs')
  },
  {
    name: "join-us",
    path: "/join-us",
    component: () => import('./join-us-Ckj0kHRP.mjs')
  },
  {
    name: "qa_test",
    path: "/qa_test",
    component: () => import('./qa_test-vdz5OjKh.mjs')
  },
  {
    name: "support",
    path: "/support",
    component: () => import('./support-BVtXepaH.mjs')
  },
  {
    name: "about-us",
    path: "/about-us",
    component: () => import('./about-us-CEdAdMQ8.mjs')
  },
  {
    name: "admin-qa",
    path: "/admin/qa",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./qa-CfgiCiAa.mjs')
  },
  {
    name: "lazy-bag",
    path: "/lazy-bag",
    component: () => import('./lazy-bag-L4Tf3qhb.mjs')
  },
  {
    name: "qa_test2",
    path: "/qa_test2",
    component: () => import('./qa_test2-luP9xSty.mjs')
  },
  {
    name: "services",
    path: "/services",
    component: () => import('./services-D4kWOX_o.mjs')
  },
  {
    name: "news-id",
    path: "/news/:id()",
    component: () => import('./_id_-nXNZQ8D4.mjs')
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./index-BO_KCcg2.mjs')
  },
  {
    name: "propaganda",
    path: "/propaganda",
    component: () => import('./propaganda-D1vOlZLb.mjs')
  },
  {
    name: "service-v1",
    path: "/service-v1",
    component: () => import('./service-v1-GnEVTepC.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./login-D0WkW8b1.mjs')
  },
  {
    name: "service-now",
    path: "/service-now",
    component: () => import('./service-now-CIg1Pm5Z.mjs')
  },
  {
    name: "announcement",
    path: "/announcement",
    component: () => import('./announcement-DBV4IVAs.mjs')
  },
  {
    name: "conduct-plan",
    path: "/conduct-plan",
    component: () => import('./conduct-plan-XUfbUfGE.mjs')
  },
  {
    name: "join-us-unit",
    path: "/join-us-unit",
    component: () => import('./join-us-unit-BdgKQ0-4.mjs')
  },
  {
    name: "admin-banners",
    path: "/admin/banners",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./banners-Dq4GHJVi.mjs')
  },
  {
    name: "reserve-guide",
    path: "/reserve-guide",
    component: () => import('./reserve-guide-Ea4ngwpL.mjs')
  },
  {
    name: "service-price",
    path: "/service-price",
    component: () => import('./service-price-BRUQTrEV.mjs')
  },
  {
    name: "admin-dashboard",
    path: "/admin/dashboard",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./dashboard-BsS71_SV.mjs')
  },
  {
    name: "admin-knowledge",
    path: "/admin/knowledge",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./knowledge-DJyBRfpu.mjs')
  },
  {
    name: "censor-standard",
    path: "/censor-standard",
    component: () => import('./censor-standard-BnGwCR26.mjs')
  },
  {
    name: "company-statute",
    path: "/company-statute",
    component: () => import('./company-statute-DEwCJEF5.mjs')
  },
  {
    name: "admin-knowledge2",
    path: "/admin/knowledge2",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./knowledge2-Bt0QqIHf.mjs')
  },
  {
    name: "admin-qa_setting",
    path: "/admin/qa_setting",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./qa_setting-DFGVxSxR.mjs')
  },
  {
    name: "all-contact-info",
    path: "/all-contact-info",
    component: () => import('./all-contact-info-DKPaj1za.mjs')
  },
  {
    name: "application-form",
    path: "/application-form",
    component: () => import('./application-form-CPgwmOOk.mjs')
  },
  {
    name: "blog-details-id",
    path: "/blog-details/:id()",
    component: () => import('./_id_-B4Szeobc.mjs')
  },
  {
    name: "convert-principle",
    path: "/convert-principle",
    component: () => import('./convert-principle-0LFM8TCc.mjs')
  },
  {
    name: "admin-service-unit",
    path: "/admin/service-unit",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./service-unit-B9hkReaM.mjs')
  },
  {
    name: "blog-details",
    path: "/blog-details",
    component: () => import('./index-yNJcFY8R.mjs')
  },
  {
    name: "service-apply-form",
    path: "/service-apply-form",
    component: () => import('./service-apply-form-O3W13wOL.mjs')
  },
  {
    name: "admin-announcements",
    path: "/admin/announcements",
    meta: __nuxt_page_meta || {},
    component: () => import('./announcements-CrqMJCLv.mjs')
  },
  {
    name: "employment-services",
    path: "/employment-services",
    component: () => import('./employment-services-DvmloNFi.mjs')
  },
  {
    name: "foreign-famliy-link",
    path: "/foreign-famliy-link",
    component: () => import('./foreign-famliy-link-DPbTRpUw.mjs')
  },
  {
    name: "experience-share-id",
    path: "/experience-share/:id()",
    component: () => import('./_id_-BVW-ezna.mjs')
  },
  {
    name: "experience-share",
    path: "/experience-share",
    component: () => import('./index-Cx-SdgKD.mjs')
  }
];
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-B_lo7ET_.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CTQuvnsG.mjs').then((m) => m.default || m)),
  "layout-one": defineAsyncComponent(() => import('./layout-one-DnaXdGNk.mjs').then((m) => m.default || m))
};
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<ul${ssrRenderAttrs(mergeProps({ class: "navbar-nav align-items-lg-center justify-content-between w-100" }, _attrs))} data-v-b9f26450><!--[-->`);
      ssrRenderList(unref(menu_data), (menu) => {
        _push(`<li class="${ssrRenderClass(`nav-item ${menu.dropdown ? "dropdown" : ""} ${menu.mega_menu ? "dropdown mega-dropdown-sm" : ""}`)}" data-v-b9f26450>`);
        if (menu.dropdown) {
          _push(`<!--[--><a style="${ssrRenderStyle({ "display": "flex", "gap": "20px" })}" class="${ssrRenderClass([{ "arrow-left": isTouchDevice.value, "rotated": isActive(menu) }, "nav-link"])}"${ssrRenderAttr("href", menu.link ? menu.link : "#")} role="button" data-v-b9f26450>`);
          if (isTouchDevice.value) {
            _push(`<span class="${ssrRenderClass({ "rotated": isActive(menu) })}" data-v-b9f26450><i class="bi bi-chevron-down" data-v-b9f26450></i></span>`);
          } else {
            _push(`<!---->`);
          }
          _push(` ${ssrInterpolate(menu.title)}</a><ul class="${ssrRenderClass([{ show: isActive(menu) }, "dropdown-menu"])}" data-v-b9f26450><!--[-->`);
          ssrRenderList(menu.dropdown_menus, (dm, i) => {
            _push(`<li class="dropdown" data-v-b9f26450>`);
            if (dm.sub_dropdown) {
              _push(`<!--[-->`);
              if (!isTouchDevice.value) {
                _push(`<div data-v-b9f26450>`);
                _push(ssrRenderComponent(_component_nuxt_link, {
                  ...
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    if (_push2) {
                      _push2(`<span data-v-b9f26450${_scopeId}>${ssrInterpolate(dm.title)}</span>`);
                    } else {
                      return [
                ...
                _push(`<div data-v-b9f26450><p class="d-none" data-v-b9f26450>in</p><a class="nav-link" style="${ssrRenderStyle({ "display": "flex", "gap": "30px" })}" href="javascript:;" role="button" data-v-b9f26450>`);
                if (isTouchDevice.value) {
                  _push(`<span class="${ssrRenderClass({ "rotated": isSubActive(dm) })}" data-v-b9f26450><i class="bi bi-chevron-down" data-v-b9f26450></i></span>`);
                } else {
                  _push(`<!---->`);
                }
                _push(` ${ssrInterpolate(dm.title)}</a></div>`);
              }
              _push(`<ul style="${ssrRenderStyle({ "padding-left": "20px" })}" class="${ssrRenderClass([{ show: isSubActive(dm) || !isTouchDevice.value }, "dropdown-menu"])}" data-v-b9f26450><!--[-->`);
              ssrRenderList(dm.sub_menus, (sub, j) => {
                _push(`<li data-v-b9f26450>`);
                if (sub.title != "就業服務法" && sub.title != "藍領審查標準" && sub.title != "外國人轉換原則") {
                  _push(ssrRenderComponent(_component_nuxt_link, {
                    href: sub.link,
                    ...
                    default: withCtx((_, _push2, _parent2, _scopeId) => {
                      if (_push2) {
                        _push2(`<span data-v-b9f26450${_scopeId}>${ssrInterpolate(sub.title)}</span>`);
                      } else {
                        return [
                  ...
                  _push(`<a${ssrRenderAttr("href", sub.link)} class="${ssrRenderClass([{ active: unref(route).path === sub.link }, "dropdown-item"])}" target="_blank" data-v-b9f26450><span data-v-b9f26450>${ssrInterpolate(sub.title)}</span></a>`);
                }
                _push(`</li>`);
              });
              _push(`<!--]--></ul><!--]-->`);
          ...
          _push(`<!--[--><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" data-v-b9f26450>${ssrInterpolate(menu.title)}</a><ul class="dropdown-menu" data-v-b9f26450><li class="row gx-1" data-v-b9f26450><!--[-->`);
          ssrRenderList(menu.mega_menus, (mm) => {
            _push(`<div class="col-lg-4" data-v-b9f26450><div class="menu-column" data-v-b9f26450><ul class="style-none mega-dropdown-list" data-v-b9f26450><!--[-->`);
            ssrRenderList(mm.menus, (sm, i) => {
              ...
              _push(ssrRenderComponent(_component_nuxt_link, {
                ...
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    _push2(`<span data-v-b9f26450${_scopeId}>${ssrInterpolate(sm.title)}</span>`);
                  } else {
                    return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b9f26450"]]);
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useRouter as b, useRoute as c, __nuxt_component_1$2 as d, entry$1 as default, __nuxt_component_0 as e, useSeoMeta as u };
