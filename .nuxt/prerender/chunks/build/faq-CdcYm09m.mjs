import { defineComponent, ref, mergeProps, useSSRContext } from 'file://C:/Users/mcsadmin/Desktop/accompany-web-site/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr } from 'file://C:/Users/mcsadmin/Desktop/accompany-web-site/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "faq-section-three pt-120 lg-pt-80 pb-40 lg-pb-80" }, _attrs))} data-v-6917add4><div class="main-container" data-v-6917add4><div class="service-grid" data-v-6917add4><!--[-->`);
      ssrRenderList(parentCategories.value, (category) => {
        _push(`<div class="service-card" data-v-6917add4><h3 class="card-title" data-v-6917add4>${ssrInterpolate(category.name)}</h3><a${ssrRenderAttr("href", `/qa_test2?id=${category.id}`)} class="service-button" data-v-6917add4> \u76F8\u95DC\u554F\u984C <span class="arrow" data-v-6917add4>\u203A</span></a>`);
        if (hasMultiLanguageContent(category.id)) {
          _push(`<div class="flag-container" data-v-6917add4><!--[-->`);
          ssrRenderList(availableLanguages(category.id), (lang, index) => {
            _push(`<a${ssrRenderAttr("href", `/qa_test2?id=${category.id}&lang=${lang.code}`)}${ssrRenderAttr("title", lang.name)} class="flag-link" data-v-6917add4><img${ssrRenderAttr("src", `/images/assets/flag-${getFlagNumber(lang.code)}.avif`)}${ssrRenderAttr("alt", lang.name)} class="flag" data-v-6917add4></a>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6917add4"]]);
...
//# sourceMappingURL=faq-CdcYm09m.mjs.map
