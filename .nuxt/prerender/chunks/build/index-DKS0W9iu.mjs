import { defineComponent, ref, withCtx, createTextVNode, mergeProps, unref, createVNode, createBlock, openBlock, Fragment, renderList, useSSRContext } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderStyle } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/vue/server-renderer/index.mjs';
import { Swiper, SwiperSlide } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/swiper/swiper-vue.mjs';
import { Autoplay, Pagination, Navigation } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/swiper/modules/index.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-banner" }, _attrs))} data-v-863eb4f1><div class="main-container" data-v-863eb4f1>`);
      if (activeBanners.value.length > 0) {
              ...
              ssrRenderList(activeBanners.value, (banner) => {
                _push2(ssrRenderComponent(unref(SwiperSlide), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="home-bg" style="${ssrRenderStyle(getBannerStyle(banner))}" data-v-863eb4f1${_scopeId2}></div>`);
                    } else {
                      return [
                        createVNode("div", {
                          class: "home-bg",
        ...
        _push(`<div class="home-bg" data-v-863eb4f1></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-863eb4f1"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><iframe credentialless width="560" height="315" src="https://www.youtube.com/embed/OxRL7eKReVQ?si=hhulgueBNpIueGKd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen data-v-72091c50></iframe><div class="main-container home-content" data-v-72091c50><div class="home-top" data-v-72091c50><h2 data-v-72091c50>\u6700\u65B0\u6D88\u606F</h2></div>`);
      if (loading.value) {
        _push(`<div class="loading-container" data-v-72091c50><div class="loading-spinner" data-v-72091c50></div><p data-v-72091c50>\u8F09\u5165\u4E2D...</p></div>`);
      } else if (error.value) {
        _push(`<div class="error-container" data-v-72091c50><p data-v-72091c50>${ssrInterpolate(error.value)}</p></div>`);
      } else {
        _push(`<div class="home-new" data-v-72091c50><!--[-->`);
        ssrRenderList(announcements.value, (announcement) => {
          _push(`<div class="new-item" data-v-72091c50><div class="new-title" data-v-72091c50><div class="title-text" data-v-72091c50>${ssrInterpolate(announcement.category)}</div><div class="title-date" data-v-72091c50>${ssrInterpolate(formatDate(announcement.publish_date))}</div></div><div class="new-link" data-v-72091c50>`);
          if (announcement.content.length > 10) {
            _push(`<a${ssrRenderAttr("href", "/news/" + announcement.id)} data-v-72091c50>${ssrInterpolate(announcement.title)}</a>`);
          } else {
            _push(`<a${ssrRenderAttr("href", announcement.link)} target="_blank" data-v-72091c50>${ssrInterpolate(announcement.title)}</a>`);
          }
          _push(`</div><div class="item-line" data-v-72091c50></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-72091c50"]]);

export { index as default };
//# sourceMappingURL=index-DKS0W9iu.mjs.map
