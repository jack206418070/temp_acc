...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "faq-section-three pt-120 lg-pt-80 pb-40 lg-pb-80" }, _attrs))} data-v-e0b795fd><div class="main-container" data-v-e0b795fd><div class="service-grid" data-v-e0b795fd><!--[-->`);
      ssrRenderList(parentCategories.value, (category, index) => {
        _push(`<div class="${ssrRenderClass([{ "mobile": index == 3 }, "service-card"])}" data-v-e0b795fd><h3 class="card-title" data-v-e0b795fd>${ssrInterpolate(category.name)}</h3><a${ssrRenderAttr("href", `/qa_test2?id=${category.id}`)} class="service-button" data-v-e0b795fd> \u76F8\u95DC\u554F\u984C <span class="arrow" data-v-e0b795fd>\u203A</span></a>`);
        if (hasMultiLanguageContent(category.id)) {
          _push(`<div class="flag-container" data-v-e0b795fd><!--[-->`);
          ssrRenderList(availableLanguages(category.id), (lang, index2) => {
            _push(`<a${ssrRenderAttr("href", `/qa_test2?id=${category.id}&lang=${lang.code}`)}${ssrRenderAttr("title", lang.name)} class="flag-link" data-v-e0b795fd><img${ssrRenderAttr("src", `/images/assets/flag-${getFlagNumber(lang.code)}.avif`)}${ssrRenderAttr("alt", lang.name)} class="flag" data-v-e0b795fd></a>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e0b795fd"]]);
...
//# sourceMappingURL=faq-CIko667t.mjs.map
