import { _ as __nuxt_component_0 } from './service-unit-list-area-Djhh1-S9.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-container" }, _attrs))} data-v-59eb1b86><div class="" data-v-59eb1b86><div class="details-meta ps-xxl-5 ps-xl-3" data-v-59eb1b86><div class="reminder-block" data-v-59eb1b86>${(_a = decode(reminder_data.value)) != null ? _a : ""}</div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=services-B3ryNKuO.mjs.map
