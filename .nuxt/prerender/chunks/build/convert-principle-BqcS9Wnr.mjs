...
import { defineComponent, mergeProps, withCtx, createBlock, openBlock, createVNode, useSSRContext } from 'file://C:/Users/mcsadmin/Desktop/accompany-web-site/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-container" }, _attrs))} data-v-58ed2b31><div class="conduct-top" data-v-58ed2b31><div class="conduct-block" data-v-58ed2b31>`);
      _push(ssrRenderComponent(_component_Nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg preserveAspectRatio="none" data-bbox="20 50.001 159.999 99.999" viewBox="20 50.001 159.999 99.999" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="shape" role="presentation" aria-hidden="true" aria-label="" data-v-58ed2b31${_scopeId}><g data-v-58ed2b31${_scopeId}><path d="M26.097 143.956c8.129 8.058 21.432 8.058 29.561 0L100 100l44.342 43.957c8.129 8.058 21.432 8.058 29.561 0 8.129-8.058 8.129-21.246 0-29.304l-59.122-58.608c-8.129-8.058-21.432-8.058-29.561 0l-59.122 58.608c-8.13 8.058-8.13 21.244-.001 29.303z" data-v-58ed2b31${_scopeId}></path></g></svg>`);
          } else {
            return [
      ...
      _push(`<h2 class="default-title" data-v-58ed2b31>\u5916\u570B\u4EBA\u8F49\u63DB\u6E96\u5247</h2></div></div><div class="conduct-content" data-v-58ed2b31><ul data-v-58ed2b31><li data-v-58ed2b31><a href="https://www.accompanytest.com/_files/ugd/73d1df_259a4f8ec0924d838b82366c36177726.pdf" target="_blank" data-v-58ed2b31>\u5916\u570B\u4EBA\u8F49\u63DB\u6E96\u5247\u6A94\u6848\u9023\u7D50</a></li></ul></div></div>`);
    };
  }
});
...
const convertPrinciple = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-58ed2b31"]]);

export { convertPrinciple as default };
//# sourceMappingURL=convert-principle-BqcS9Wnr.mjs.map
