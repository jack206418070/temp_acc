...
import { ref, mergeProps, unref, withCtx, createVNode, useSSRContext } from 'file:///Users/ginjack/Desktop/accompany-web-site/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent } from 'file:///Users/ginjack/Desktop/accompany-web-site/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-icon" data-v-e554f5ed${_scopeId}>\u{1F4DD}</div><h3 data-v-e554f5ed${_scopeId}>\u554F\u7B54\u7BA1\u7406</h3><p data-v-e554f5ed${_scopeId}>\u7BA1\u7406\u7DB2\u7AD9\u5E38\u898B\u554F\u984C</p>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-icon" data-v-e554f5ed${_scopeId}>\u{1F4DA}</div><h3 data-v-e554f5ed${_scopeId}>\u77E5\u8B58\u5EAB\u7BA1\u7406</h3><p data-v-e554f5ed${_scopeId}>\u7BA1\u7406\u77E5\u8B58\u5EAB\u5716\u7247</p>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-icon" data-v-e554f5ed${_scopeId}>\u{1F3E2}</div><h3 data-v-e554f5ed${_scopeId}>\u670D\u52D9\u55AE\u4F4D\u7BA1\u7406</h3><p data-v-e554f5ed${_scopeId}>\u7BA1\u7406\u670D\u52D9\u55AE\u4F4D\u8CC7\u8A0A</p>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-icon" data-v-e554f5ed${_scopeId}>\u{1F4E2}</div><h3 data-v-e554f5ed${_scopeId}>\u516C\u544A\u7BA1\u7406</h3><p data-v-e554f5ed${_scopeId}>\u7BA1\u7406\u7DB2\u7AD9\u516C\u544A\u5167\u5BB9</p>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-icon" data-v-e554f5ed${_scopeId}>\u{1F5BC}\uFE0F</div><h3 data-v-e554f5ed${_scopeId}>Banner \u7BA1\u7406</h3><p data-v-e554f5ed${_scopeId}>\u7BA1\u7406\u9996\u9801\u8F2A\u64AD\u5716\u7247</p>`);
          } else {
            return [
...
//# sourceMappingURL=dashboard-09iO2yJ3.mjs.map
