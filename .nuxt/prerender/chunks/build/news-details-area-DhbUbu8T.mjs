...
import { ssrInterpolate, ssrRenderAttr, ssrRenderList } from 'file:///Users/ginjack/Desktop/accompany-web-site/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="post-category" data-v-e996a296>\u985E\u5225\uFF1A${ssrInterpolate(blog.value.category)}</div></div><div class="post-details-meta" data-v-e996a296> \u5167\u5BB9\uFF1A<br data-v-e996a296><div class="post-content" data-v-e996a296>${(_a = decode(blog.value.content)) != null ? _a : ""}</div></div>`);
        if (blog.value.link) {
      ...
      if (showPopup.value && blog.value.images) {
        ...
        _push(`<button class="close-btn" data-v-e996a296>\xD7</button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--]-->`);
...
//# sourceMappingURL=news-details-area-DhbUbu8T.mjs.map
