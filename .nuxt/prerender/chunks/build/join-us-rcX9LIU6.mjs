import { _ as __nuxt_component_0$1 } from './breadcrumb-one-BAmdWqdo.mjs';
import { u as useSeoMeta, _ as _export_sfc, a as __nuxt_component_0$2 } from './server.mjs';
import { defineComponent, withCtx, createTextVNode, mergeProps, resolveComponent, useSSRContext } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderAttr, ssrRenderAttrs, ssrInterpolate } from 'file:///Users/ginjack/Desktop/temp_acc/node_modules/vue/server-renderer/index.mjs';
import { p as publicAssetsURL } from '../_/renderer.mjs';
import { _ as _imports_3, a as _imports_0$2, b as _imports_1$2, c as _imports_2$1 } from './virtual_public-CLuFllmE.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "accordion-item" }, _attrs))} data-v-b5926ee1><div class="accordion-header"${ssrRenderAttr("id", "heading" + _ctx.id)} data-v-b5926ee1><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"${ssrRenderAttr("data-bs-target", "#collapse" + _ctx.id)}${ssrRenderAttr("aria-expanded", false)}${ssrRenderAttr("aria-controls", "collapse" + _ctx.id)} data-v-b5926ee1>${ssrInterpolate(_ctx.title)}</button></div><div${ssrRenderAttr("id", "collapse" + _ctx.id)} class="accordion-collapse collapse"${ssrRenderAttr("aria-labelledby", "heading" + _ctx.id)}${ssrRenderAttr("data-bs-parent", "#" + _ctx.parent)} data-v-b5926ee1><div class="accordion-body" data-v-b5926ee1><p class="faq-answer" data-v-b5926ee1>${ssrInterpolate(_ctx.desc)}</p></div></div></div>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b5926ee1"]]);
const _sfc_main$2 = {};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_breadcrumb_one = __nuxt_component_0$1;
...
//# sourceMappingURL=join-us-rcX9LIU6.mjs.map
