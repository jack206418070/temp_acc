import { defineComponent, mergeProps, ref, useSSRContext } from 'file://C:/Users/mcsadmin/Desktop/accompany-web-site/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderStyle } from 'file://C:/Users/mcsadmin/Desktop/accompany-web-site/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "plan-service" }, _attrs))} data-v-81bcbbe5><div class="position-relative" data-v-81bcbbe5><h2 data-v-81bcbbe5>\u670D\u52D9\u5C0D\u8C61</h2><div class="row m-auto" data-v-81bcbbe5><!--[-->`);
      ssrRenderList(serviceSteps, (item, index) => {
        _push(`<div class="col-md wow fadeInUp"${ssrRenderAttr("data-wow-delay", `${index * 0.2}s`)} data-v-81bcbbe5><div class="step-item text-center mb-lg-4 mb-2" data-v-81bcbbe5><div class="step-number" data-v-81bcbbe5>${ssrInterpolate(index + 1)}</div><div class="step-title" data-v-81bcbbe5>${ssrInterpolate(item.title)}</div></div><div class="description-box p-20 mb-4" data-v-81bcbbe5><p data-v-81bcbbe5>${ssrInterpolate(item.description)}</p></div><div class="notes-box" data-v-81bcbbe5><p style="${ssrRenderStyle({ "white-space": "pre-line" })}" data-v-81bcbbe5>${ssrInterpolate(item.note)}</p></div></div>`);
      });
      _push(`<!--]--></div></div></div>`);
    };
  }
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-81bcbbe5"]]);
...
//# sourceMappingURL=about-us-DqEKdEII.mjs.map
