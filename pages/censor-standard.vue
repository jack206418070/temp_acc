<template>
  <div class="main-container">
    <div class="conduct-top">
      <div class="conduct-block">
        <Nuxt-link class="pre-link" href="/company-statute">
        ...
        <h2 class="default-title">藍領審查標準</h2>
      </div>
    </div>
    <div class="conduct-content">
      <ul>
        <li>
          <a href="https://www.accompanytest.com/_files/ugd/73d1df_ec28f395ab544df99126831c5ef9bf18.pdf" target="_blank">藍領審查標準檔案下載</a>
        </li>
      </ul>
    </div>
  </div>
