...
<script setup lang="ts">
  ...
  const allQA = [
    ...
    <ul>
        <li>
          「多元陪伴照顧服務工作者」於113年11月16日經本部公告核定適用勞動基準法第 84條之 1 之工作者，其工時約定可採每日正常工作時間 12 小 時，連同延長工作時間 2 小時。每月工作總時數上限不得超過 288 小時。倘雇主與前該工作者約定並經核備之「正常工作時間」超過「法定正常工作時間」之時數，其每月之最低工資應按超過之時數增給，並非以每月28,590 元(114 年最低工資)為限，且不得損及勞工之健康及福祉。
        </li>
        <li>
          ...
          <ul>
              <li>勞雇雙方如約定且經核備之每月正常工時為 240 小時，其最低工資應以28,590 元+〔28,590 元/240 小時*（240-174）小時〕計算，約為 36,453元。
              </li>
              <li>勞雇雙方如約定且經核備之每月正常工時為 264 小時，其最低工資應以28,590 元+〔28,590 元/240 小時*（264-174）小時〕計算，約為 39,312元。</li>
              <li> 勞雇雙方如約定且經核備之每月正常工時為 288 小時，其最低工資應以28,590 元+〔28,590 元/240 小時*（288-174）小時〕計算，約為42,171 元。</li>
          </ul>
        </li>
        <li>假設雇主與勞工約定每月正常工時為 240 小時，當月延長工時為 40 小時 (每日前 2 小時內)，工作總時數合計為 280 小時為例，其每月工資總額不得低於 42,807 元(最低工資 36,453 元+加班費 6,354 元)。
